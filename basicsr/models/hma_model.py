...
class HMAModel(SRModel):
    ...
    def test_selfensemble(self):
        ...
        self.pre_process()  # sets self.img
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        # real_dataset is a Subset, so get the *actual* dataset
        ...
        # 1. If we have an ensemble setting in opt
        ...
        for idx, val_data in enumerate(dataloader):
            ...
            self.feed_data(val_data)  # feed data once, or inside the ensemble function

            # 2. If we have ensemble paths, do model ensemble
